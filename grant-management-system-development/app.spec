...
%define      app_directory grant_management

Name:        miamioh-php-grant_management
Version:     %{_version}
Summary:     Grad School Grant Management
URL:         https://git.itapps.miamioh.edu/cse-capstone/grant-management-system
